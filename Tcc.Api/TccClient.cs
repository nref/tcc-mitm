...
public interface ITccClient
{
    ...
    Task<bool> SetAsync(int coolSetpoint);
}
...
public class TccClient : ITccClient
{
    ...
    public async Task<bool> SetAsync(int coolSetpoint) => (await PostAsync("https://tccna.resideo.com/ws/MobileV2.asmx/ChangeThermostatUI", 
